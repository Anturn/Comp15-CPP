        ...
        if(!leaf->isEmpty()){
                if(leaf->hasFiles()){ 
                        ...
                        for(int i = 0; i < num_files; i++){
                                ...
                                cout << " This is the file name: " << name << endl;
                                read(name,path);
                                cout << " Successful here in 52 in hashTable.cpp " << endl;
                ...
                if(leaf->hasSubDir()){
                        ...
                        for(int i = 0; i < num_dirs; i++){
                                ...
                                run(dir,prefix);
                                cout << " Successful here in 63 in hashTable.cpp " << endl;
...
void hashTable::run1()
{
        ...
        do{
                cout << "Query? " << endl;
                cin >> command;
                if (command == "@i" || command == "@insensitive"){
                        string word;
			                  cin >> word;
			                  word = toLC(word);
			                  mode_i(word);
